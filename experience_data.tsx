		...
		description: (
			<p className='text-sm leading-relaxed text-gray-300'>
				...
				<li>
					...
					(CSAT) score by 4% via a quarter-long front-end modernization effort
					for two SaaS solutions by scoping and delegating improvements based on
					UX's mock-ups
				</li>
				<li>
					<strong>Team Efficiency:</strong> Reduced team-wide pull request (PR)
					turnaround to less than one day by automating a GitHub PR tracker for
					my team's slack channel specifically tailored to aggregate open issues
					and delegate reviewers
				</li>
			</p>
		),
		dates: 'May 2022 - Present',
		stack: ['React', 'Dart', 'Redux', 'Kotlin', 'Go', 'Python'],
	},
	{
		...
		description: (
			<p className='text-sm leading-relaxed text-gray-300'>
				...
				<li>
					...
					documentation and UML diagrams in an organized and hierarchical
					fashion
				</li>
			</p>
		),
